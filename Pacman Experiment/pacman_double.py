...
##### Can change the parameters listed below to change the grid size.
...
def save_model(dict_state):
    ...
    relatively_safe_pickle_dump(dict_state, "./model_state.pkl.zip", compression=True)

def load_model():
    load_state("./model.ckpt")
    dict_state = pickle_load("./model_state.pkl.zip", compression=True)
    return dict_state
